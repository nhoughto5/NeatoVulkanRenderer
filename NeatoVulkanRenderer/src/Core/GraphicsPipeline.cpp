...
GraphicsPipeline::GraphicsPipeline(PhysicalDevice* physicalDevice, LogicalDevice* logicalDevice, SwapChain* swapChain, RenderPass* renderPass) :
...
VkPipelineLayout GraphicsPipeline::getGraphicsPipelineLayout()
{
...
VkDescriptorPool GraphicsPipeline::createDescriptorPool() {
	...
	poolSizes[1].descriptorCount = static_cast<uint32_t>(m_SwapChain->getSwapChainImages().size());
