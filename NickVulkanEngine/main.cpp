...
// Finds the address of the 'vkCreateDebugReportCallbackEXT' extension function as it is not loaded automatically
...
private:
	...
	void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
		...
		// Record a shopping list of commands
		...
		// Stop recording list of commands
    ...
    bool isDeviceSuitable(VkPhysicalDevice device) {
        ...
        if (extensionsSupported) {
            ...
            swapChainsAdequate = !swapChainSupport.formats.empty() && !swapChainSupport.presentModes.empty();
        }
        return indices.isComplete() && extensionsSupported && swapChainsAdequate;
    }
